...
const VehicleCard = (item) => {
    ...
    function handleClick(e) {
        e.preventDefault();
        favorites.push(item.character.properties.name)
      }
    return (
        <div className="col">
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <Link to={'/vehicle/'+item.vehicle.uid} className="btn btn-primary">See more</Link>
                    <button href="#" className="btn btn-warning bi bi-chat-right-heart float-end" onClick={handleClick}>
